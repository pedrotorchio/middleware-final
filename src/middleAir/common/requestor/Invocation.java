...
//    }
    ...
    public Invocation setUid(String uid){
        this.uid = uid;
        return this;
    }
    ...
    public Invocation clone(){
        ...
        Invocation invoc = (Invocation)super.clone();

                   invoc.setUid(getUid());
                   invoc.setPort(getPort());
                   invoc.setIp(getIp());
                   invoc.setMethodName(getMethodName());
                   invoc.setParameters(getParameters());
                   invoc.setBody(getBody());
